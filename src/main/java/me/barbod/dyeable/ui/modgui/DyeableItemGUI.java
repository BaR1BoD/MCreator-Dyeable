package me.barbod.dyeable.ui.modgui;
...
public class DyeableItemGUI extends ModElementGUI<DyeableItem> {
    ...
    private final TextureHolder overlayTexture = new TextureHolder(new TypedTextureSelectorDialog(mcreator, TextureType.ITEM));

    private final JCheckBox isDyeable = L10N.checkbox("elementgui.common.enable");
    private final JColor defaultColor = new JColor(mcreator, false, false);

    private final JCheckBox canWaterRemoveColor = L10N.checkbox("elementgui.common.enable");
    private final JCheckBox canLavaRemoveColor = L10N.checkbox("elementgui.common.enable");
    private final JCheckBox canPowderSnowRemoveColor = L10N.checkbox("elementgui.common.enable");
    ...
    protected void initGUI() {
        ...
        overlayTexture.setOpaque(false);

        JPanel texturesPanel = new JPanel(new BorderLayout());
        texturesPanel.setOpaque(false);

        texturesPanel.add(ComponentUtils.squareAndBorder(texture, L10N.t("elementgui.item.texture")), BorderLayout.WEST);
        texturesPanel.add(ComponentUtils.squareAndBorder(overlayTexture, L10N.t("elementgui.dyeable.common.overlay_texture")), BorderLayout.EAST);
        ...
        isDyeable.setOpaque(false);
        isDyeable.addChangeListener(e -> {
            defaultColor.setEnabled(isDyeable.isSelected());
            canWaterRemoveColor.setEnabled(isDyeable.isSelected());
            canLavaRemoveColor.setEnabled(isDyeable.isSelected());
            canPowderSnowRemoveColor.setEnabled(isDyeable.isSelected());
        });
        ...
        dyeProperties.add(L10N.label("elementgui.dyeable.common.is_dyeable"));
        dyeProperties.add(isDyeable);

        dyeProperties.add(L10N.label("elementgui.dyeable.common.default_color"));
        dyeProperties.add(defaultColor);

        canWaterRemoveColor.setOpaque(false);
        canWaterRemoveColor.setEnabled(isDyeable.isSelected());

        canLavaRemoveColor.setOpaque(false);
        canLavaRemoveColor.setEnabled(isDyeable.isSelected());

        canPowderSnowRemoveColor.setOpaque(false);
        canPowderSnowRemoveColor.setEnabled(isDyeable.isSelected());

        dyeProperties.add(HelpUtils.wrapWithHelpButton(withEntry("dyeable/remove_water"),
                L10N.label("elementgui.dyeable.common.can_water_remove_color")));
        dyeProperties.add(canWaterRemoveColor);

        dyeProperties.add(HelpUtils.wrapWithHelpButton(withEntry("dyeable/remove_lava"),
                L10N.label("elementgui.dyeable.common.can_lava_remove_color")));
        dyeProperties.add(canLavaRemoveColor);

        dyeProperties.add(HelpUtils.wrapWithHelpButton(withEntry("dyeable/remove_powder_snow"),
                L10N.label("elementgui.dyeable.common.can_powder_snow_remove_color")));
        dyeProperties.add(canPowderSnowRemoveColor);
        ...
        addPage(L10N.t("elementgui.dyeable.common.dye"), dyePane);
    ...
    protected void openInEditingMode(DyeableItem dyeableItem) {
        name.setText(dyeableItem.name);
        rarity.setSelectedItem(dyeableItem.rarity);
        texture.setTextureFromTextureName(dyeableItem.texture);
        onRightClickedInAir.setSelectedProcedure(dyeableItem.onRightClickedInAir);
        onRightClickedOnBlock.setSelectedProcedure(dyeableItem.onRightClickedOnBlock);
        onCrafted.setSelectedProcedure(dyeableItem.onCrafted);
        onEntityHitWith.setSelectedProcedure(dyeableItem.onEntityHitWith);
        onItemInInventoryTick.setSelectedProcedure(dyeableItem.onItemInInventoryTick);
        onItemInUseTick.setSelectedProcedure(dyeableItem.onItemInUseTick);
        onStoppedUsing.setSelectedProcedure(dyeableItem.onStoppedUsing);
        onEntitySwing.setSelectedProcedure(dyeableItem.onEntitySwing);
        onDroppedByPlayer.setSelectedProcedure(dyeableItem.onDroppedByPlayer);
        creativeTab.setSelectedItem(dyeableItem.creativeTab);
        stackSize.setValue(dyeableItem.stackSize);
        enchantability.setValue(dyeableItem.enchantability);
        toolType.setValue(dyeableItem.toolType);
        useDuration.setValue(dyeableItem.useDuration);
        damageCount.setValue(dyeableItem.damageCount);
        recipeRemainder.setBlock(dyeableItem.recipeRemainder);
        immuneToFire.setSelected(dyeableItem.immuneToFire);
        destroyAnyBlock.setSelected(dyeableItem.destroyAnyBlock);
        stayInGridWhenCrafting.setSelected(dyeableItem.stayInGridWhenCrafting);
        damageOnCrafting.setSelected(dyeableItem.damageOnCrafting);
        specialInformation.setSelectedProcedure(dyeableItem.specialInformation);
        glowCondition.setSelectedProcedure(dyeableItem.glowCondition);
        damageVsEntity.setValue(dyeableItem.damageVsEntity);
        enableMeleeDamage.setSelected(dyeableItem.enableMeleeDamage);
        guiBoundTo.setSelectedItem(dyeableItem.guiBoundTo);
        inventorySize.setValue(dyeableItem.inventorySize);
        inventoryStackSize.setValue(dyeableItem.inventoryStackSize);
        isFood.setSelected(dyeableItem.isFood);
        isMeat.setSelected(dyeableItem.isMeat);
        isAlwaysEdible.setSelected(dyeableItem.isAlwaysEdible);
        onFinishUsingItem.setSelectedProcedure(dyeableItem.onFinishUsingItem);
        nutritionalValue.setValue(dyeableItem.nutritionalValue);
        saturation.setValue(dyeableItem.saturation);
        animation.setSelectedItem(dyeableItem.animation);
        eatResultItem.setBlock(dyeableItem.eatResultItem);
        enableRanged.setSelected(dyeableItem.enableRanged);
        shootConstantly.setSelected(dyeableItem.shootConstantly);
        projectile.setSelectedItem(dyeableItem.projectile);
        rangedUseCondition.setSelectedProcedure(dyeableItem.rangedUseCondition);
        onRangedItemUsed.setSelectedProcedure(dyeableItem.onRangedItemUsed);

        // Dyeable start

        overlayTexture.setTextureFromTextureName(dyeableItem.dyeableItem.overlayTexture());
        isDyeable.setSelected(dyeableItem.dyeableItem.isDyeable());
        defaultColor.setColor(dyeableItem.dyeableItem.defaultColor());
        canWaterRemoveColor.setSelected(dyeableItem.dyeableItem.canWaterRemoveColor());
        canLavaRemoveColor.setSelected(dyeableItem.dyeableItem.canLavaRemoveColor());
        canPowderSnowRemoveColor.setSelected(dyeableItem.dyeableItem.canPowderSnowRemoveColor());
        ...
        customProperties.setProperties(dyeableItem.customProperties);
        customProperties.setStates(dyeableItem.states);
    }

    @Override
    public DyeableItem getElementFromGUI() {
        DyeableItem item = new DyeableItem(modElement);
        ...
        item.dyeableItem = new DyeableItemProperties(overlayTexture.getID(), isDyeable.isSelected(), defaultColor.getColor(),
                canWaterRemoveColor.isSelected(), canLavaRemoveColor.isSelected(), canPowderSnowRemoveColor.isSelected());
